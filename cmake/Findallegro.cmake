...
if (PKGCONFIG_FOUND)
  ...
  foreach (VERSION_STR_IT ${VERSION_STRS})
      string(REGEX MATCH "[0-9].[0-9]" VERSION_N_STR "${VERSION_STR_IT}")

      if ("${VERSION_N_STR}" STREQUAL "")
        string(REGEX MATCH "[0-9]" VERSION_N_STR "${VERSION_STR_IT}")
    endif()

    if (${VERSION_N_STR} VERSION_GREATER ${allegro_VERSION})
        set(allegro_VERSION "${VERSION_N_STR}")
    endif ()
  endforeach ()
